...
Source0  : https://files.pythonhosted.org/packages/1e/92/9a38750369d8f323d4ef31927119bfbc3d8bcce5b01f52950d873318b26b/msgpack-1.0.1.tar.gz
...
%prep
%setup -q -n msgpack-1.0.1
cd %{_builddir}/msgpack-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607730276
...
cp %{_builddir}/msgpack-1.0.1/COPYING %{buildroot}/usr/share/package-licenses/msgpack/175e59be229a5bedc6be93e958a970385bb04a62
